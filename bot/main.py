"""
КРОК 3: Telegram бот з логуванням

Що нового в цьому кроці:
- ✅ Красиві кольорові логи в консолі (loguru)
- ✅ Автоматичне збереження логів у файли
- ✅ Різні рівні логування (DEBUG, INFO, WARNING, ERROR)
- ✅ Замість print() тепер використовуємо logger
...
2. Встановлені залежності: aiogram, pydantic-settings, loguru
...
- Bot, Dispatcher - основа aiogram
- settings - налаштування з config.py (читає .env)
- logger - логування з loguru (замість print)
"""
...
async def cmd_start(message: Message):
    ...
    - КРОК 3: Логує інформацію про користувача
    """
...
async def main():
    ...
    5. КРОК 3: Всі етапи логуються через logger
    """
...
if __name__ == "__main__":
    ...
    logger.info("=" * 50)
    logger.info("🌾 FERM BOT - КРОК 3: Логування через loguru")
    logger.info("=" * 50)
