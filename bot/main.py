"""
КРОК 4: Telegram бот з базою даних

Що нового в цьому кроці:
- ✅ Підключення до БД (SQLite через SQLAlchemy 2.0)
- ✅ Модель User для збереження користувачів
- ✅ Автоматичне створення таблиць
- ✅ Збереження користувача при /start
...
if __name__ == "__main__":
    ...
    logger.info("=" * 50)
    logger.info("🌾 FERM BOT - КРОК 4: База даних (SQLAlchemy)")
    logger.info("=" * 50)
