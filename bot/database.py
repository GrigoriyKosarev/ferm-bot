    ...
    async with async_session_maker() as session:
        ...
        products = [
            Product(
                ...
                product_url="https://ferm.in.ua/mikrodobrivo-ultrastart-ul-trastart-marka-a-20-kg-kvadrat-/p-1586",
            ...
            Product(
                ...
                product_url="https://ferm.in.ua/mikrodobrivo-intermag-oliini-20-l/p-2690",
                category_id=cat_micro.id,
                available=True,
            ),
            Product(
                ...
                product_url="https://ferm.in.ua/mikrodobrivo-avangard-crystalmax-b-21-avangard-kristalmaks-10-kg-ukravit-science-park-/p-1034",
                category_id=cat_micro.id,
                available=True,
            ),
            Product(
